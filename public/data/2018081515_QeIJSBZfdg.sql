...
INSERT INTO `td_action_log` VALUES (20,1,'admin',1,'修改菜单【数据管理】成功',1534302384,'127.0.0.1');
INSERT INTO `td_action_log` VALUES (21,1,'admin',1,'添加菜单【数据备份】成功',1534302409,'127.0.0.1');
INSERT INTO `td_action_log` VALUES (22,1,'admin',1,'修改菜单【数据管理】成功',1534302477,'127.0.0.1');
INSERT INTO `td_action_log` VALUES (23,1,'admin',1,'添加菜单【数据恢复】成功',1534302593,'127.0.0.1');
INSERT INTO `td_action_log` VALUES (24,1,'admin',1,'添加菜单【清除缓存】成功',1534303266,'127.0.0.1');
INSERT INTO `td_action_log` VALUES (25,1,'admin',1,'删除菜单【id=21】成功',1534316945,'127.0.0.1');
--
-- 表的结构 `td_auth_admin`
-- 
...
INSERT INTO `td_auth_rule` VALUES (18,'#','数据管理',1,1,'fa fa-gear','',0,10,1534296175,1534302477);
INSERT INTO `td_auth_rule` VALUES (19,'tdmin/database/database','数据备份',1,1,'','',18,0,1534302409,1534302409);
INSERT INTO `td_auth_rule` VALUES (20,'tdmin/database/restore','数据恢复',1,1,'','',18,2,1534302593,1534302593);
--
-- 表的结构 `td_member`
-- 
